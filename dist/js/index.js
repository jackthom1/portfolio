...
var mediaWidth = window.matchMedia("(min-width: 1440px)");
...
var animationChange = function animationChange(container) {
  var tl = gsap.timeline({
    defaults: {
      ease: 'power1.out'
    }
...
var animationLeave = function animationLeave(container, done) {
  var tl = gsap.timeline({
    defaults: {
      ease: 'power1.out'
    }
...
var items = document.getElementsByClassName("hero__slider");
...
},{"@barba/core":2}],2:[function(require,module,exports){
